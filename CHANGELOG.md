...
- **Enhanced Shell Safety**: Improved dangerous command interceptor, path traversal prevention
- **Improved Uninstaller**: Enterprise-grade uninstall with Windows PowerShell cleanup, cross-platform entry point cleanup, and post-uninstall validation
...
- **CI/CD Pipeline**: Removed `continue-on-error: true` from security scans, added test job with coverage reporting
- **Type Annotations**: Fixed type hints in multiple files for better mypy compliance
- **Lambda Type Inference**: Fixed type annotations for lambda functions in redact.py
- **API Key Validation**: Improved handling of None API key in pre-flight checks
...
| [1.0.0] | 2024-03-28 | ✅ Current |
| [0.2.0] | 2024-03-28 | ⚠️ Legacy |
...
[Unreleased]: https://github.com/krittaphato3/MultiCode/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/krittaphato3/MultiCode/compare/v0.2.0...v1.0.0
